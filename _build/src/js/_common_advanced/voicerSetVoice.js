...
const voicerSetVoice = (func) => {
  ...
  if (tgt_lang.length > 0 || tgt_voice.length > 0) {
    ...
    setTimeout(function () {
      ...
      // 名前で並び変える
      arraySort(voicer.ary_voice, "name");
      ...
      // 言語で並び替える
      arraySort(voicer.ary_voice, "lang");
      
      // 重複を削除して、lang用の配列をつくる
      voicer.ary_voice_lang = arrayDelDouble(voicer.ary_voice, "lang");
      ...
      /*
       * 言語アイコン
       * notice: 端末によって、ja-JP ja_JP のように「-」「_」があるので、そのケアもしている
       */
